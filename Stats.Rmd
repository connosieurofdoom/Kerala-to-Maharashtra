...
hDataKM <- rbind( Kerala, Maharashtra)

barplot(hDataKM, beside=T, names.arg = c("PrimaryHC", "CommunityHC", "SubDistrictHospitals", "DistrictHospitals", "TotalPublicHealthFacilities", "PublicBeds", "RuralHospitals", "RuralBeds", "UrbanHospitals", "UrbanBeds"), args.legend = list(title = "State", x = "topright", cex = .7), col = c("darkgreen", "red") ,las=2.5, cex.axis=1, font=1)
...
cat("Number of Cases in Pune:", nP, "Number of Cases in Kannur:", nM, fill = TRUE)
